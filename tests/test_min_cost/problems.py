...
def get_problem_b() -> MinCostProblem:
    ...
    edge_source_b = CapacitatedCostEdge((source_node, node_b), capacity=1, cost=2)

    edge_a_b = CapacitatedCostEdge((node_a, node_b), capacity=1, cost=2)
    ...
    edge_b_sink = CapacitatedCostEdge((node_b, sink_node), capacity=2, cost=2)
